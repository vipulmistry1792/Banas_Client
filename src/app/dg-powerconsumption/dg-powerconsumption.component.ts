...
@Component({
  selector: 'app-dg-powerconsumption',
  templateUrl: './dg-powerconsumption.component.html',
  styleUrls: ['./dg-powerconsumption.component.css']
})
export class DgPowerconsumptionComponent implements OnInit {
  ...
  showData()
  {
    ...
    this.timeseries.getDGConsumption(data)
    .pipe(first())
    .subscribe(mqttda => {
      console.log(mqttda)
